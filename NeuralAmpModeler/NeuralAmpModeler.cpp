...
: Plugin(info, MakeConfig(kNumParams, kNumPresets))
{
  ...
  mLayoutFunc = [&](IGraphics* pGraphics) {
    ...
    // FILTERS & MIX button to the right of modelArea (NAM field), shifted 2px to left (R + 2.0f)
    ...
    // Mono/Stereo button to the right of irArea (IR field), shifted 2px to left (R + 2.0f)
